    ...
    <MaxWidthWrapper>
      ...
      <div className="border-t border-gray-200 py-6">
        <p className="mx-auto max-w-3xl text-center text-xs leading-relaxed text-muted-foreground">
          Tento web není skutečný e-shop. Vznikl jako self-learning projekt v
          Next.js a jde o plně funkční demo. Všechny produkty jsou smyšlené
          (mock), jejich obrázky jsou generované pomocí Nano Banana Pro 2 a
          platby běží přes Stripe v testovacím režimu: reálné platební karty
          nefungují a žádné peníze se nestrhnou.
        </p>
      </div>
