...
export const ReceiptEmail = ({
	...
	const total = products.reduce((acc, curr) => acc + curr.price, 0) + 25;

	return (
		<Html>
			<Head />
			<Preview>Vaše DigiShark Faktura</Preview>
				...
				<Container style={container}>
					<Section>
						...
						<Column align="right" style={tableCell}>
							<Text style={heading}>Účtenka</Text>
						</Column>
					</Section>
					<Section style={informationTable}>
						<Row style={informationTableRow}>
							...
							<Column style={informationTableColumn}>
								<Text style={informationTableLabel}>DATUM FAKTURACE</Text>
					...
					<Section style={productTitleTable}>
						<Text style={productsTitle}>Shrnutí objednávky</Text>
					</Section>
					...
					<Section>
						...
						>
							<Text style={productTitle}>Transakční poplatek</Text>
						</Column>
					...
					<Section align="right">
						<Column style={tableCell} align="right">
							<Text style={productPriceTotal}>CELKEM</Text>
						</Column>
					...
					<Text style={footerLinksWrapper}>
						<Link href="#">Nastavení účtu</Link> •{" "}
						<Link href="#">Obchodní podmínky</Link> •{" "}
						<Link href="#">Zásady ochrany osobních údajů</Link>
					</Text>
					<Text style={footerCopyright}>
						Copyright © 2023 DigiShark Inc. <br />{" "}
						<Link href="#">Všechna práva vyhrazena</Link>
					</Text>
				</Container>
			</Body>
		</Html>
