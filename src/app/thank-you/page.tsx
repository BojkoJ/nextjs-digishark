                    ...
                    <div className='lg:col-start-2'>
                        ...
                        {order._isPaid ? (
                            <p className='mt-2 text-base text-muted-foreground'>
                                Vaše objednávky byla zpracována a vaše produkty
                                si můžete ihned stáhnout. Poslali jsme vám také
                                fakturu a detaily objedávnky na{" "}
                            ...
                            <p className='mt-2 text-base text-muted-foreground'>
                                Ceníme si vaší objednávky a aktuálně ji
                                zpracováváme. Prosíme vydržte a my vám brzy
                                pošleme potvrzení.
                            </p>
                        )}
