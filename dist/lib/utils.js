...
function constructMetadata(_a) {
	var _b = _a === void 0 ? {} : _a,
		_c = _b.title,
		title = _c === void 0 ? "DigiShark - tržiště digitálních produktů" : _c,
		_d = _b.description,
		description =
			_d === void 0
				? "DigiShark je open-source tržiště s kvalitním digitálním zbožím."
				: _d,
		_e = _b.image,
		image = _e === void 0 ? "/logo.png" : _e,
		_f = _b.icons,
		icons = _f === void 0 ? "/digishark_logo.png" : _f,
		_g = _b.noIndex,
	...
	return __assign(
		{
			...
			metadataBase: new URL(
				"https://nextjs-digishark-production.up.railway.app"
			),
		},
		noIndex && {
			robots: {
